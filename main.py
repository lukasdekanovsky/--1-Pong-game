...
def setup_screen(screen):
    """Setup initial screen with black bg, 800x600 and corresponding title"""
...
def game(screen, ball, paddle_a, paddle_b, score):
    ...
    while game_on:
        ...
        # TODO 3: Score
        if ball_x_coordinates < 330 and ball_x_coordinates > - 330: #ball is out of paddles 
            pass 
            ...
            score.increase_score("player_a") # paddle missed the ball
            ...
            score.increase_score("player_b") # paddle missed the ball
